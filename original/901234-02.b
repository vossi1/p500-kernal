; da65 V2.17 - Git N/A
; Created:    2020-04-18 23:40:06
; Input file: 901234-02.bin
; Page:       1
...
; ----------------------------------------------------------------------------
e6509           := $0000                        ; 6509 execution bank
i6509           := $0001                        ; 6509 indirect bank
fnadr           := $0090                        ; Far address of file name
sal             := $0093                        ; Start address low
sah             := $0094                        ; Start address high
sas             := $0095                        ; Start address seg
eal             := $0096                        ; End address low
eah             := $0097                        ; End address high
eas             := $0098                        ; End address seg
stal            := $0099
stah            := $009A
stas            := $009B
status          := $009C                        ; Status byte
fnlen           := $009D                        ; Length of file name
la              := $009E                        ; Logical file number
fa              := $009F                        ; Device address
sa              := $00A0                        ; Secondary address
dfltn           := $00A1                        ; Current input device
dflto           := $00A2                        ; Current output device
tape1           := $00A3                        ; Address of tape buffer
ribuf           := $00A6                        ; Address of rs232 buffer
stkey           := $00A9                        ; Stop key flag
c3po            := $00AA                        ; IEC buffer flag
bsour           := $00AB                        ; IEC output buffer
ipoint          := $00AC                        ; RAM indirect pointer
pch             := $00AE                        ; Monitor: PC low
pcl             := $00AF                        ; Monitor: PC high
sp              := $00B4                        ; Monitor: stack pointer
xi6509          := $00B5                        ; Monitor: indirect bank
invh            := $00B7                        ; Monitor: user irq low
invl            := $00B8                        ; Monitor: user irq high
tmp1            := $00B9                        ; Monitor: temp ptr 1
tmp2            := $00BB                        ; Monitor: temp ptr 2
tmpc            := $00BD                        ; Monitor: last command
t6509           := $00BE                        ; Monitor: current indirect bank
ddisk           := $00BF                        ; Monitor: disk device number
pkybuf          := $00C0                        ; Start of function keys
keypnt          := $00C2
sedsal          := $00C4
sedeal          := $00C6
pnt             := $00C8                        ; Current position in video RAM
tblx            := $00CA                        ; Cursor position: line
pntr            := $00CB                        ; Cursor position: column
grmode          := $00CC                        ; Flag for text/graph mode
lstx            := $00CD                        ; Scancode of last key pressed
lstp            := $00CE
lsxp            := $00CF
crsw            := $00D0
ndx             := $00D1
qtsw            := $00D2                        ; Quote mode flag
insrt           := $00D3                        ; Insert mode flag
config          := $00D4                        ; Cursor type
indx            := $00D5
kyndx           := $00D6
rptcnt          := $00D7                        ; Keyboard repeat counter
delay           := $00D8                        ; Kbd repeat delay counter
sedt1           := $00D9                        ; Screen editor temp storage #1
sedt2           := $00DA                        ; Screen editor temp storage #2
data            := $00DB                        ; Current output character
sctop           := $00DC                        ; Top line of current window
scbot           := $00DD                        ; Bottom line of current window
sclf            := $00DE                        ; Left border of current window
scrt            := $00DF                        ; Right border of current window
modkey          := $00E0                        ; Flag for shift/control keys
norkey          := $00E1
bitabl          := $00E2
blnon           := $00E6                        ; Blinking cursor on
blncnt          := $00E7                        ; Blink counter
user            := $00E8                        ; Ptr to color ram
tcolor          := $00EA                        ; Temporary color
blnsw           := $00EB                        ; Blink switch
color           := $00EC                        ; Character color
gdcol           := $00ED                        ; Color behind cursor
saver           := $00EE                        ; Temp store for output char
scrseg          := $00EF                        ; Segment of video ram
stack           := $0100
stackp          := $01FF
...
; ----------------------------------------------------------------------------
keword: .byte   " YEK"                          ; E856 20 59 45 4B               YEK
crword: .byte   "31($RHC+"                      ; E85A 33 31 28 24 52 48 43 2B  31($RHC+
        .byte   $22                             ; E862 22                       "
qtword: .byte   "43($RHC+"                      ; E863 34 33 28 24 52 48 43 2B  43($RHC+
        .byte   $22                             ; E86B 22                       "
; ----------------------------------------------------------------------------
...
normtb: .byte   $E0,$1B,$09,$FF,$00,$01,$E1,$31 ; EAB1 E0 1B 09 FF 00 01 E1 31  .......1
...
shfttb: .byte   $EA,$1B,$89,$FF,$00,$01,$EB,$21 ; EB11 EA 1B 89 FF 00 01 EB 21  .......!
...
shftgr: .byte   $EA,$1B,$89,$FF,$00,$01,$EB,$21 ; EB71 EA 1B 89 FF 00 01 EB 21  .......!
...
ctrltb: .byte   $FF,$FF,$FF,$FF,$FF,$FF,$FF,$A1 ; EBD1 FF FF FF FF FF FF FF A1  ........
...
LEC30:  .byte   $FF                             ; EC30 FF                       .
; ----------------------------------------------------------------------------
; DLOAD "*" + RUN
runtab: .byte   "D"                             ; EC31 44                       D
        .byte   $CC,$22                         ; EC32 CC 22                    ."
        .byte   "*"                             ; EC34 2A                       *
        .byte   $0D                             ; EC35 0D                       .
        .byte   "RUN"                           ; EC36 52 55 4E                 RUN
        .byte   $0D                             ; EC39 0D                       .
; ----------------------------------------------------------------------------
; Start of screen lines, low bytes
ldtab2: .byte   $00,$28,$50,$78,$A0,$C8,$F0,$18 ; EC3A 00 28 50 78 A0 C8 F0 18  .(Px....
...
ldtab1: .byte   $D0,$D0,$D0,$D0,$D0,$D0,$D0,$D1 ; EC53 D0 D0 D0 D0 D0 D0 D0 D1  ........
...
keylen: .byte   $05,$04,$06,$06,$05,$06,$04,$09 ; ECAC 05 04 06 06 05 06 04 09  ........
        .byte   $07,$05                         ; ECB4 07 05                    ..
; ----------------------------------------------------------------------------
; Function key definitions
keydef1:.byte   "PRINT"                         ; ECB6 50 52 49 4E 54           PRINT
; Text for function key F2
keydef2:.byte   "LIST"                          ; ECBB 4C 49 53 54              LIST
; Text for function key F3
keydef3:.byte   "DLOAD"                         ; ECBF 44 4C 4F 41 44           DLOAD
        .byte   $22                             ; ECC4 22                       "
; Text for function key F4
keydef4:.byte   "DSAVE"                         ; ECC5 44 53 41 56 45           DSAVE
        .byte   $22                             ; ECCA 22                       "
; Text for function key F5
keydef5:.byte   "DOPEN"                         ; ECCB 44 4F 50 45 4E           DOPEN
; Text for function key F6
keydef6:.byte   "DCLOSE"                        ; ECD0 44 43 4C 4F 53 45        DCLOSE
; Text for function key F7
keydef7:.byte   "COPY"                          ; ECD6 43 4F 50 59              COPY
; Text for function key F8
keydef8:.byte   "DIRECTORY"                     ; ECDA 44 49 52 45 43 54 4F 52  DIRECTOR
                                                ; ECE2 59                       Y
; Text for function key F9
keydef9:.byte   "SCRATCH"                       ; ECE3 53 43 52 41 54 43 48     SCRATCH
; Text for function key F10
keydef10:
        .byte   "CHR$("                         ; ECEA 43 48 52 24 28           CHR$(
; ----------------------------------------------------------------------------
; Generic bit mask table
bits:   .byte   $80,$40,$20,$10,$08,$04,$02,$01 ; ECEF 80 40 20 10 08 04 02 01  .@ .....
; Register values for VIC initialization
vicinit:.byte   $1B,$00,$00,$00,$00,$08,$00,$40 ; ECF7 1B 00 00 00 00 08 00 40  .......@
        .byte   $8F,$00,$00,$00,$00,$00,$00,$03 ; ECFF 8F 00 00 00 00 00 00 03  ........
        .byte   $01                             ; ED07 01                       .
; ----------------------------------------------------------------------------
; Extended editor vector table (copied to $3B5)
edvect: .addr   LE9F6                           ; ED08 F6 E9                    ..
        .addr   wrtvram                         ; ED0A 41 E6                    A.
        .addr   wrtcram                         ; ED0C 50 E6                    P.
        .addr   nofunc                          ; ED0E 39 E0                    9.
        .addr   nofunc                          ; ED10 39 E0                    9.
; ----------------------------------------------------------------------------
; Table with color values
colortb:.byte   $90,$05,$1C,$9F,$9C,$1E,$1F,$9E ; ED12 90 05 1C 9F 9C 1E 1F 9E  ........
        .byte   $81,$95,$96,$97,$98,$99,$9A,$9B ; ED1A 81 95 96 97 98 99 9A 9B  ........
; Unused space
unused1:.byte   $00,$AA,$AA,$AA,$AA,$AA,$AA,$AA ; ED22 00 AA AA AA AA AA AA AA  ........
...
cmds:   .byte   ":"                             ; EED1 3A                       :
; ----------------------------------------------------------------------------
        .addr   msetmem                         ; EED2 F7 EF                    ..
; ----------------------------------------------------------------------------
        .byte   ";"                             ; EED4 3B                       ;
; ----------------------------------------------------------------------------
        .addr   msetreg                         ; EED5 C5 EF                    ..
; ----------------------------------------------------------------------------
        .byte   "R"                             ; EED7 52                       R
; ----------------------------------------------------------------------------
        .addr   mregs                           ; EED8 41 EF                    A.
; ----------------------------------------------------------------------------
        .byte   "M"                             ; EEDA 4D                       M
; ----------------------------------------------------------------------------
        .addr   mdump                           ; EEDB 84 EF                    ..
; ----------------------------------------------------------------------------
        .byte   "G"                             ; EEDD 47                       G
; ----------------------------------------------------------------------------
        .addr   mgo                             ; EEDE 14 F0                    ..
; ----------------------------------------------------------------------------
        .byte   "L"                             ; EEE0 4C                       L
; ----------------------------------------------------------------------------
        .addr   mload                           ; EEE1 43 F0                    C.
; ----------------------------------------------------------------------------
        .byte   "S"                             ; EEE3 53                       S
; ----------------------------------------------------------------------------
        .addr   mload                           ; EEE4 43 F0                    C.
; ----------------------------------------------------------------------------
        .byte   "V"                             ; EEE6 56                       V
; ----------------------------------------------------------------------------
        .addr   mbank                           ; EEE7 DF EF                    ..
; ----------------------------------------------------------------------------
        .byte   "@"                             ; EEE9 40                       @
; ----------------------------------------------------------------------------
        .addr   mdisk                           ; EEEA 68 F1                    h.
; ----------------------------------------------------------------------------
        .byte   "Z"                             ; EEEC 5A                       Z
; ----------------------------------------------------------------------------
        .addr   kipcgo                          ; EEED 72 FF                    r.
; ----------------------------------------------------------------------------
        .byte   "X"                             ; EEEF 58                       X
; ----------------------------------------------------------------------------
        .addr   mexit                           ; EEF0 F5 EE                    ..
; ----------------------------------------------------------------------------
        .byte   "U"                             ; EEF2 55                       U
; ----------------------------------------------------------------------------
        .addr   mdunit                          ; EEF3 EB EF                    ..
; ----------------------------------------------------------------------------
...
reghead:.byte   $0D                             ; EF26 0D                       .
        .byte   "   PC  IRQ  SR AC XR YR SP"    ; EF27 20 20 20 50 43 20 20 49     PC  I
...
kmsgtab:.byte   $0D                             ; F1CA 0D                       .
        .byte   "I/O ERROR "                    ; F1CB 49 2F 4F 20 45 52 52 4F  I/O ERRO
                                                ; F1D3 52 20                    R 
        .byte   $A3,$0D                         ; F1D5 A3 0D                    ..
        .byte   "SEARCHING"                     ; F1D7 53 45 41 52 43 48 49 4E  SEARCHIN
                                                ; F1DF 47                       G
        .byte   $A0                             ; F1E0 A0                       .
        .byte   "FOR"                           ; F1E1 46 4F 52                 FOR
        .byte   $A0,$0D                         ; F1E4 A0 0D                    ..
        .byte   "LOADIN"                        ; F1E6 4C 4F 41 44 49 4E        LOADIN
        .byte   $C7,$0D                         ; F1EC C7 0D                    ..
        .byte   "SAVING"                        ; F1EE 53 41 56 49 4E 47        SAVING
        .byte   $A0,$0D                         ; F1F4 A0 0D                    ..
        .byte   "VERIFYIN"                      ; F1F6 56 45 52 49 46 59 49 4E  VERIFYIN
        .byte   $C7,$0D                         ; F1FE C7 0D                    ..
        .byte   "FOUND"                         ; F200 46 4F 55 4E 44           FOUND
        .byte   $A0,$0D                         ; F205 A0 0D                    ..
        .byte   "OK"                            ; F207 4F 4B                    OK
        .byte   $8D,$0D                         ; F209 8D 0D                    ..
        .byte   "** MONITOR 1.0 **"             ; F20B 2A 2A 20 4D 4F 4E 49 54  ** MONIT
                                                ; F213 4F 52 20 31 2E 30 20 2A  OR 1.0 *
                                                ; F21B 2A                       *
        .byte   $8D,$0D                         ; F21C 8D 0D                    ..
        .byte   "BREA"                          ; F21E 42 52 45 41              BREA
        .byte   $CB                             ; F222 CB                       .
; ----------------------------------------------------------------------------
...
txbyt4: lda     tpi1_pa                         ; F303 AD 00 DE                 ...
        ora     #$10                            ; F306 09 10                    ..
        sta     tpi1_pa                         ; F308 8D 00 DE                 ...
txbyt4: lda     #$FF                            ; F30B A9 FF                    ..
...
ramtas: lda     #$00                            ; FA94 A9 00                    ..
        tax                                     ; FA96 AA                       .
LFA97:  sta     a:$02,x                         ; FA97 9D 02 00                 ...
...
jmptab: .addr   kirq                            ; FB09 F8 FB                    ..
        .addr   timb                            ; FB0B 21 EE                    !.
        .addr   panic                           ; FB0D B8 FC                    ..
        .addr   open                            ; FB0F C6 F6                    ..
        .addr   close                           ; FB11 F4 F5                    ..
        .addr   chkin                           ; FB13 50 F5                    P.
        .addr   ckout                           ; FB15 AA F5                    ..
        .addr   clrch                           ; FB17 AD F6                    ..
        .addr   basin                           ; FB19 A3 F4                    ..
        .addr   bsout                           ; FB1B F5 F4                    ..
        .addr   stop                            ; FB1D 72 F9                    r.
        .addr   getin                           ; FB1F 44 F4                    D.
        .addr   clrall                          ; FB21 86 F6                    ..
        .addr   load                            ; FB23 4D F7                    M.
        .addr   save                            ; FB25 53 F8                    S.
        .addr   mcmd                            ; FB27 73 EE                    s.
        .addr   jescape                         ; FB29 1F E0                    ..
        .addr   jescape                         ; FB2B 1F E0                    ..
        .addr   secnd                           ; FB2D 7B F2                    {.
        .addr   tksa                            ; FB2F 87 F2                    ..
        .addr   acptr                           ; FB31 11 F3                    ..
        .addr   ciout                           ; FB33 9E F2                    ..
        .addr   untalk                          ; FB35 B2 F2                    ..
        .addr   unlsn                           ; FB37 B6 F2                    ..
        .addr   listn                           ; FB39 3B F2                    ;.
        .addr   talk                            ; FB3B 37 F2                    7.
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
; Unused space
unused2:.byte   $AC,$AA,$AA,$AA,$AA,$AA,$AA,$AA ; FF36 AC AA AA AA AA AA AA AA  ........
...
; ----------------------------------------------------------------------------
        .byte   $80                             ; FFF9 80                       .
; Hardware NMI vector
hanmi:  .addr   nmi                             ; FFFA 3D FB                    =.
; Hardware reset vector
hares:  .addr   cold                            ; FFFC 9E F9                    ..
; Hardware IRQ vector
hairq:  .addr   irq                             ; FFFE E5 FB                    ..
